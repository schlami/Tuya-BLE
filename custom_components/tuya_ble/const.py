...
# "/v1.0/iot-03/devices/factory-infos", newer ones use
# "/v1.0/devices/factory-infos". Using the latter avoids 60009001
# "API permission package error" when fetching factory info.
